...
func TestExampleConfig_IsValidAndStatesTheDefaults(t *testing.T) {
	...
	for k, want := range map[string]string{
		...
		"MOANSUBS_REVISION_RATE_PER_HOUR":  strconv.Itoa(api.RevisionRateLimitPerHour),
		"MOANSUBS_REVISION_MAX_DIVERGENCE": strconv.FormatFloat(api.DefaultRevisionMaxDivergence, 'f', -1, 64),
		"MOANSUBS_REVISION_RETIME_HINT":    "true",
